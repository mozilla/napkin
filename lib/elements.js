...
exports.add = function(req, db, callback) {
  ...
  crud.add(req, 'project:' + req.body.project_id + ':component:' + req.body.id + ':element',
...
exports.update = function(req, db, identifier, callback) {
  crud.update(req, 'project:' + req.body.project_id + ':component:' + req.body.id + ':element:' + identifier,
...
exports.remove = function(req, db, identifier, callback) {
  crud.remove(req, 'project:' + req.body.project_id + ':componenet:' + req.body.id + ':element:' + identifier,
